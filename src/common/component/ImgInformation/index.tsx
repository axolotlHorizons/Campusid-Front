...
function FormRow() {
  return (
    <React.Fragment>
      ...
      <Paper className={classes.root}> <Avatar alt="Etudiant CampusID" src="https://www.nautiljon.com/images/manga_persos/00/57/guts_175.jpg" className={classes.large}/> </Paper> 
      </Grid>
      <Grid item xs={12}  container justify="center" alignItems="center">
